...
next(_, Row, Col) when Row =:= 2, Col =:= 2 -> 1;
next(ListOfLists, Row, Col) when Row =:= 2, Col =:= length(ListOfLists) - 1 -> 1;
next(ListOfLists, Row, Col) when Row =:= length(ListOfLists) - 1, Col =:= 2 -> 1;
next(ListOfLists, Row, Col) when Row =:= length(ListOfLists) - 1, Col =:= length(ListOfLists) - 1 -> 1;
